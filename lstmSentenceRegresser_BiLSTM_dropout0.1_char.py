...
if __name__ == '__main__':
    ...
    for emotion in emotionlist:
        ...
        for SEED in seedlist:
            ...
            model = LSTMRegresser(embedding_dim=EMBEDDING_DIM, hidden_dim=HIDDEN_DIM,
                                  vocab_size=len(char_to_ix), n_output=1)
            ...
            test_pred_res, all_losses, all_losses_dev = train(model, loss_Function, optimizer, train_data, dev_data,
                                                              test_data, char_to_ix, EPOCH=EPOCH)
            ...
            plotpath = 'plots/BiLSTMdropout0.1layer2_char/'
            ...
            predpath = 'predictions/BiLSTMdropout0.1layer2_char/'
