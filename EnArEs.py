...
def trainArEs(model, loss_Function, optimizer, train_data, dev_data, word_to_ix, EPOCH=50):
    #best_dev_acc = 0.0
    ...
    for i in range(EPOCH):
        ...
        if dev_avgloss < best_dev_avgloss:
            ...
            if no_drop >= 10:
                #exit()
                break
    return model, all_losses, all_losses_dev

def train(model, loss_Function, optimizer, train_data, dev_data, test_data, word_to_ix, emotion, seed, testfile, predpath, best_char_dev_avgloss=1.0, EPOCH=100):
    #best_dev_acc = 0.0
    #print('->dev_data:', dev_data)
...
if __name__ == '__main__':
    ...
    for emotion in emotionlist:
        ...
        for SEED in seedlist:
            ...
            #model, all_losses, all_losses_dev = trainArEs(model, loss_Function, optimizer, train_dataAr, dev_dataAr, word_to_ixAr, EPOCH=EPOCH)
            model, all_losses, all_losses_dev = trainArEs(model, loss_Function, optimizer, train_dataAr, dev_dataAr, word_to_ixAr, EPOCH=EPOCH)

            plotpath = 'plots/ArEsEn_exp1/Ar/'
            #plotpath = 'plots/ArEsEn_exp1/Es/'
            ...
            predpath = 'predictions/ArEsEn_exp1/En_Ar/'
            if not os.path.exists(predpath):
                os.makedirs(predpath)

            best_char_dev_avgloss = 1.0
            test_pred_res, all_losses, all_losses_dev = train(model, loss_Function, optimizer, train_data, dev_data, test_data, word_to_ix, emotion, SEED, testfile, predpath, best_char_dev_avgloss=best_char_dev_avgloss, EPOCH=EPOCH)
            ...
            plotpath = 'plots/ArEsEn_exp1/En_Ar/'
            if not os.path.exists(plotpath):
                os.makedirs(plotpath)
